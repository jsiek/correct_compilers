...
expressions but retains the structured control-flow and
...
locations, which are mutable. The abstract syntax for assignment is
...
% LocalWords:  retB thenB pred GHC thn eval Agda's transl condexpr wb
% LocalWords:  stmt arg dest regs DestOK trans Lawall Appel Sumii cg
% LocalWords:  Grune Isabelle Hatcliff vn Kelsey uq Birkedal movq int
% LocalWords:  basicstyle mathescape callq subq
